//screen value
const screenValue:any = (document.getElementById("display") as HTMLInputElement);
const screenValue2:any = (document.getElementById("display2") as HTMLInputElement);
//empty array
let memoryArray:any = [];
...
function operation(oper:any) {
    ...
    switch (oper) {
        ...
        case 'equal': //equal
            ...
            break;
        case 'log': //log10
            let logResult:Number = Math.log(Number(screenValue.value)) / Math.log(10);
